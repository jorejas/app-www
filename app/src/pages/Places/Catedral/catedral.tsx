...
import { IonCard , IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonImg, IonSlides, IonSlide, IonButton, IonPopover, IonText } from '@ionic/react';
        ...
        <div>
          <IonCard color="light">
              ...
              <IonCardContent>
                ...
                <IonButton expand="block" onClick={() => setShowPopover(true)}>→</IonButton>
          </IonCard>
          <IonPopover
            isOpen={showPopover}
            animated= {true}
